...
import { Assertion, CheckError, CheckRequest, CheckRequestTupleKey, CheckResponse, ConsistencyPreference, ContextualTupleKeys, CreateStoreRequest, CreateStoreResponse, ExpandRequest, ExpandRequestTupleKey, ExpandResponse, GetStoreResponse, ListObjectsRequest, ListObjectsResponse, ListStoresResponse, ListUsersRequest, ListUsersResponse, ReadAssertionsResponse, ReadAuthorizationModelResponse, ReadAuthorizationModelsResponse, ReadChangesResponse, ReadRequestTupleKey, ReadResponse, TupleKey, TupleKeyWithoutCondition, WriteAuthorizationModelRequest, WriteAuthorizationModelResponse, WriteRequestWritesOnDuplicate, WriteRequestDeletesOnMissing } from "./apiModel";
...
export declare const ClientWriteRequestOnDuplicateWrites: typeof WriteRequestWritesOnDuplicate;
export declare const ClientWriteRequestOnMissingDeletes: typeof WriteRequestDeletesOnMissing;
...
export declare class OpenFgaClient extends BaseAPI {
     ...
     * @param {number} [options.retryParams.minWaitInMs] - Override the minimum wait before a retry is initiated
     */
    writeTuples(tuples: TupleKey[], options?: ClientRequestOptsWithAuthZModelId & ClientWriteTuplesRequestOpts): Promise<ClientWriteResponse>;
    /**
     ...
     * @param {number} [options.retryParams.minWaitInMs] - Override the minimum wait before a retry is initiated
     */
    deleteTuples(tuples: TupleKeyWithoutCondition[], options?: ClientRequestOptsWithAuthZModelId & ClientDeleteTuplesRequestOpts): Promise<ClientWriteResponse>;
    /************************
