 ...
 */
export function validateEmail(input: string): { valid: boolean; value?: string; error?: string } {
 ...
 */
export function validatePhone(input: string): { valid: boolean; value?: string; error?: string } {
    const trimmed = input.trim();
 ...
 */
export function validateCurrency(input: string): { valid: boolean; value?: number; formatted?: string; error?: string } {
    const trimmed = input.trim();
 ...
 */
export function validateNumber(input: string): { valid: boolean; value?: number; error?: string } {
    const trimmed = input.trim();
 ...
 */
export function validateDate(input: string): { valid: boolean; value?: Date; formatted?: string; error?: string } {
 ...
 */
export function validateTime(input: string): { valid: boolean; value?: string; formatted?: string; error?: string } {
    const trimmed = input.trim().toLowerCase();
...
export function validateField(
    fieldType: string,
    input: string
): { valid: boolean; value?: any; formatted?: string; error?: string } {
